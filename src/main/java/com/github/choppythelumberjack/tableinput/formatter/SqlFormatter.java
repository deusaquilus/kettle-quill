 ...
 *
 */
package com.github.choppythelumberjack.tableinput.formatter;
...
public class SqlFormatter {
	...
	public String format(String source) {
		...
		formatConfiguration.newlineAfterCommaAfterByOrFromOrSelect = false;
		return new FormatProcess(source, formatConfiguration).perform();
	}

	public static class FormatConfiguration {
		public boolean newlineAfterCommaAfterByOrFromOrSelect = false;
	}
	...
	private static class FormatProcess {
		...
		public FormatProcess(String sql, FormatConfiguration formatConfiguration) {
		...
		private void commaAfterByOrFromOrSelect() {
			out();
			if (formatConfiguration.newlineAfterCommaAfterByOrFromOrSelect) newline();
		}
