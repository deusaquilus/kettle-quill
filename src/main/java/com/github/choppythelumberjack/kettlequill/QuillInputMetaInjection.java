 ...
 * @author Chris
 */
public class QuillInputMetaInjection implements StepMetaInjectionInterface {
    ...
    private QuillInputMeta meta;

    public QuillInputMetaInjection(QuillInputMeta meta ) {
        this.meta = meta;
    }
    ...
    public void injectStepMetadataEntries( List<StepInjectionMetaEntry> all ) throws KettleException {
        ...
        for ( StepInjectionMetaEntry lookFields : all ) {
            ...
            switch ( fieldsEntry ) {
                case SQL:
                    meta.setSql(scala.Option.apply(lookValue));
                    break;
